...
def create_application() -> FastAPI:
    ...
    api_v1_router.include_router(misp.router)
    ...
    api_v1_router.include_router(ioc.router)
    api_v1_router.include_router(bulk.router)
    api_v1_router.include_router(bulk_sse.router)
    api_v1_router.include_router(reports.router)
    api_v1_router.include_router(v1_me.router)
